...
const SUPPORT_SERVICE_LOOKUP = Object.fromEntries(
  SUPPORT_SERVICES.map((item) => [item.title, item]),
);
...
const SERVICE_LANDING_PAGES = [
  {
    ...
    description:
      "Respectful personal care support shaped around comfort, privacy, and the way each participant prefers daily routines to be handled.",
    focus:
      "We take time to understand what feels comfortable, what matters most in daily routines, and how support can be delivered in a way that protects dignity and independence from the very beginning.",
    includes: ["Hygiene support", "Dressing and grooming", "Daily personal routines"],
    suitableFor: [
      "Participants who want gentle support with personal routines",
      "People looking for consistency, privacy, and dignity at home",
      "Families wanting reliable everyday care in Adelaide",
    ],
    expectation:
      "Support begins with listening. We aim to understand the participant’s pace, preferences, and comfort levels so daily care feels steady, respectful, and never rushed.",
  },
  {
    title: "Daily Living Assistance",
    eyebrow: "Everyday Support",
    description:
      "Practical support with household tasks and routines that helps everyday life feel safer, more settled, and easier to manage.",
    focus:
      "Support is shaped around the way the participant already lives, with practical help that reduces pressure while creating a more comfortable and manageable routine at home.",
    includes: ["Cleaning", "Meal preparation", "Household routines"],
    suitableFor: [
      "Participants who want support with home-based routines",
      "People needing help to keep the home settled and organised",
      "Participants building confidence in everyday living tasks",
    ],
    expectation:
      "This support is designed to feel practical and dependable, with a focus on helping the participant maintain a home environment that supports comfort, routine, and independence.",
  },
  {
    title: "Community Participation",
    eyebrow: "Everyday Support",
    description:
      "Support to stay active, connected, and involved in the community in a way that feels meaningful, comfortable, and participant-led.",
    focus:
      "We start with what matters to the participant, then build support around confidence, interests, familiar places, and everyday community life so participation feels more natural and less stressful.",
    includes: ["Social activities", "Appointments", "Community connection"],
    suitableFor: [
      "Participants wanting more confidence out in the community",
      "People building social connection and routine outside the home",
      "Participants who want support to attend activities or appointments",
    ],
    expectation:
      "Community support should feel personal, not generic. We focus on building confidence at a pace that suits the participant while keeping connection, comfort, and choice front and centre.",
  },
  {
    title: "Transport Support",
    eyebrow: "Everyday Support",
    description:
      "Safe and reliable transport support for appointments, errands, and day-to-day community access across Adelaide.",
    focus:
      "Transport support is delivered with punctuality, clear communication, and a calm approach that helps participants feel comfortable and well supported getting where they need to go.",
    includes: ["Appointments", "Community access", "Everyday travel support"],
    suitableFor: [
      "Participants who need transport to appointments or activities",
      "People who want dependable support getting around Adelaide",
      "Families looking for a calm and practical transport option",
    ],
    expectation:
      "We know reliable transport matters. The focus is on making each trip feel organised, clear, and supportive so participants can attend what matters with less stress.",
  },
  {
    title: "Life Skills Development",
    eyebrow: "Building Independence",
    description:
      "Practical support that builds confidence with routines, planning, and everyday independent living skills over time.",
    focus:
      "We work alongside participants at their pace, focusing on progress that feels realistic, useful, and genuinely connected to everyday life rather than overwhelming or rushed.",
    includes: ["Routine development", "Independent skills", "Confidence building"],
    suitableFor: [
      "Participants working toward more independence day to day",
      "People wanting support with planning, routines, and practical skills",
      "Participants who benefit from steady encouragement and structure",
    ],
    expectation:
      "This support is about steady progress. We focus on practical goals that matter to the participant and help build confidence in a way that feels achievable and relevant.",
  },
  {
    title: "Mentoring & Routine Support",
    eyebrow: "Building Independence",
    description:
      "Ongoing one-to-one support focused on structure, confidence, and a more settled day-to-day routine.",
    focus:
      "This support is built around rapport, consistency, and understanding what helps the participant feel motivated, comfortable, and well supported across everyday life.",
    includes: ["Routine support", "One-on-one mentoring", "Personal encouragement"],
    suitableFor: [
      "Participants wanting more structure across the week",
      "People who value consistent one-to-one support",
      "Participants building confidence with goals and daily rhythm",
    ],
    expectation:
      "We aim to build support around trust and consistency, so participants feel understood, encouraged, and supported in a way that fits their own rhythm.",
  },
  {
    title: "1:1 Support",
    eyebrow: "Flexible Support Options",
    description:
      "Personalised one-to-one support tailored to the participant’s routines, goals, preferences, and daily needs.",
    focus:
      "With one dedicated support person during the shift, there is more room to focus on comfort, communication, and the participant’s own pace and preferences.",
    includes: ["Individual care", "Flexible support", "Participant-focused attention"],
    suitableFor: [
      "Participants who prefer dedicated one-to-one support",
      "People who benefit from consistency and direct attention",
      "Participants wanting flexible help built around their own routine",
    ],
    expectation:
      "One-to-one support gives more space for individual attention, clearer communication, and a support approach built around what works best for that participant.",
    image: "/mentoring-routine-photo.png",
    imagePosition: "50% center",
    color: "#8b5cf6",
    surface: "#f3eaff",
    placeholderHint: "One-to-one participant-led support",
  },
  {
    title: "2:1 Support",
    eyebrow: "Flexible Support Options",
    description:
      "Additional support for participants who need a higher level of assistance in specific routines, environments, or situations.",
    focus:
      "Where extra support is needed, two workers can help create a safer and steadier experience while still keeping the participant at the centre of decisions, routines, and communication.",
    includes: ["Complex support", "Increased assistance", "Extra support where needed"],
    suitableFor: [
      "Participants with higher support needs in some settings",
      "People who benefit from extra assistance for safety or confidence",
      "Families seeking a more supported option for specific routines",
    ],
    expectation:
      "Extra support should still feel personal. We keep the focus on safety, steadiness, and participant comfort while making sure support remains respectful and well coordinated.",
    image: "/life-skills-photo.png",
    imagePosition: "50% center",
    color: "#2153a5",
    surface: "#e2ecff",
    placeholderHint: "Extra support for higher needs",
  },
];

const SERVICE_LANDING_LOOKUP = Object.fromEntries(
  SERVICE_LANDING_PAGES.map((item) => {
    const visual = SUPPORT_SERVICE_LOOKUP[item.title] || {};
    ...
    return [
      item.title,
      {
        ...
        imagePosition: item.imagePosition || visual.imagePosition || "center center",
        color: item.color || visual.color || "#1098d5",
        surface: item.surface || visual.surface || "#eef6fb",
        placeholderHint:
          item.placeholderHint || visual.placeholderHint || item.description,
      },
    ];
  }),
);
...
function ServicesPageCard({ item, onClick }) {
  return (
    <button type="button" className="services-page-card" onClick={onClick}>
      <h3>{item.title}</h3>
      <p>{item.description}</p>
      ...
      <span className="services-page-link">Learn more</span>
    </button>
  );
}
...
function ServicesPage({ setPage, openServicePage }) {
  return (
            ...
            <div className="services-page-grid">
              {group.items.map((item, itemIndex) => (
                ...
                >
                  <ServicesPageCard
                    item={item}
                    onClick={() => openServicePage(item.title)}
                  />
                </Reveal>
              ))}
            </div>
...
function ServiceLandingPage({ item, setPage, setService, setEnquiryForm }) {
  const fallbackSrc = createPlaceholderImage(
    item.title,
    item.placeholderHint,
    item.color,
  ...
  const handleRequestSupport = () => {
    if (INTEREST_OPTIONS.includes(item.title)) {
  ...
  return (
    <section className="content-section service-landing-page">
      <div
        className="service-landing-hero"
        style={{
          "--service-accent": item.color,
          "--service-surface": item.surface,
        }}
      >
        <div className="service-landing-copy">
          ...
          <div className="feature-list is-compact">
            <div className="feature-item">
              <span className="feature-dot" />
              <span>Available for self-managed and plan-managed NDIS participants in Adelaide</span>
            </div>
          ...
          <div className="button-row">
            <button type="button" className="button button-primary" onClick={handleRequestSupport}>
              Request Support
            </button>
            <button
              type="button"
        ...
        <div className="service-landing-visual">
          <SmartImage
            ...
            fallbackSrc={fallbackSrc}
            alt={item.title}
            className="service-landing-image"
            style={{ objectPosition: item.imagePosition || "center center" }}
          />
        </div>
      </div>
      ...
      <div className="service-landing-grid">
        <article className="service-landing-card">
          <h2>What this support can include</h2>
          <div className="feature-list is-compact">
            {item.includes.map((point) => (
              <div key={point} className="feature-item">
                <span className="feature-dot" />
      ...
      <div className="service-landing-expectation">
        <article className="service-landing-card service-landing-card-wide">
          <h2>What participants can expect</h2>
          <p>{item.expectation}</p>
        </article>
      </div>

      <div className="service-landing-fit">
        <div className="services-group-header">
          <h2 className="services-group-title">Who this may suit</h2>
        </div>
        <div className="services-page-grid service-landing-fit-grid">
          {item.suitableFor.map((point) => (
            <article key={point} className="service-fit-card">
              <p>{point}</p>
            </article>
          ))}
        </div>
      ...
      <div className="services-page-cta">
        <h2 className="services-page-cta-title">Every participant’s routine matters</h2>
        <p className="section-copy">
          We start by understanding what feels comfortable, what matters day to day, and how support can fit around the participant rather than the other way around.
        </p>
        <button type="button" className="button button-primary" onClick={handleRequestSupport}>
          Request Support
        </button>
...
export default function App() {
  ...
  const [selectedServicePage, setSelectedServicePage] = useState(
    SERVICE_LANDING_PAGES[0].title,
  );
  ...
  }, [page, selectedServicePage]);

  const openServicePage = (title) => {
    setSelectedServicePage(title);
    setPage("service-detail");
  };

  const activeNavPage = page === "service-detail" ? "services" : page;
  ...
  return (
    <div className="app-shell">
      ...
      <main className="page-shell">
        ...
        {page === "services" && (
          <ServicesPage setPage={setPage} openServicePage={openServicePage} />
        )}
        {page === "service-detail" && (
          <ServiceLandingPage
            item={SERVICE_LANDING_LOOKUP[selectedServicePage]}
            setPage={setPage}
            setService={setService}
            setEnquiryForm={setEnquiryForm}
          />
